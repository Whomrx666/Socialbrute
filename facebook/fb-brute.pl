...
#
# Description:
# Ox Cracker is a password cracking tool written in perl to perform a dictionary-based attack on a specific Facebook user through HTTPS.
#
# Usage:
# perl Ox-Bruter.pl login wordlist
...
#
# --- Ox-Bruter Facebook password cracking tool
# --- By Mr.X
# --- www.facebook.com/whomrx
#
